...
execute if score timer timer matches 1.. run schedule function espadatornado:initespada/reloj/timer2 1s
execute as @e[tag=tornado] at @s run playsound minecraft:entity.ender_dragon.flap master @a ~ ~ ~ 10 1 1
